<template>
  <li class="thread" v-if="thread.isOver">#{{ thread.id}} - <a :href="thread.threadURL" target="_blank">visit</a> - won by <a :href="thread.winnerURL">{{ thread.winner.username }}</a> {{ thread.timeAgo }} - {{ thread.bid }} credits</li>
